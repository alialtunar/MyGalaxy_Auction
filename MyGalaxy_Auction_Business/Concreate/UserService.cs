...
namespace MyGalaxy_Auction_Business.Concreate
{
    public class UserService : IUserService
    {
        ...
        public UserService(RoleManager<IdentityRole> roleManager,IConfiguration _configuration,ApplicationDbContext context,IMapper mapper,ApiResponse response,UserManager<ApplicationUser> userManager)
        {
